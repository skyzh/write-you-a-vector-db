...
- Do not inspect `../vector-datafusion`, `../vector-core`, Git history, remote
  branches, or published solutions.
- You may read the Rust course chapters and `../vector-core-starter`.
- Preserve exact fallback for every unsupported physical-expression shape.
- Run the focused tests listed by the chapter before moving to IVFFlat.
