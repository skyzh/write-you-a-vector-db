...
Implement the TODOs in `vector-starter/` in chapter order. The `vector/`ntree contains completed references; keep it closed while you work throughnthe exercises.
