...
out-of-bounds code crashes the decoder or silently reads garbage bytes.
...
ordering. Reporting approximate distances as exact changes the result
order relative to reranking.
...
retained for reranking. Including or excluding the wrong components
makes the compression ratio unreproducible across chapters.
